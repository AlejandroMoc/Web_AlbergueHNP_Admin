...
const {
  ...
  getAllClientInfo,
  registerNewPatient,
  registerEntradaUnica,
  getcarnet,
  updateInfocliente,
  updateInfoentrada,
  getcarnetEdit,
} = require("./queries/UsernewQueries.js");
const {
  getAllClients,
  getClientsByFilter,
  banClient,
  unbanClient,
  deleteClient,
} = require("./queries/UserListQueries.js");
const {
  getHuespedInfo,
  getclienteInfoD,
  getDeudaCliente,
  ...
  getVetado,
  getNotaVeto,
} = require("./queries/InfoUserQueries.js");
const {
  getInfo,
  regServacio,
  regPago,
  ...
  eliminarCama,
  anadCama,
} = require("./queries/RoomAdminQueries.js");
const {
  getAllUsers,
  getAllHuespedes,
  getUserInfo,
  getAllVisitantes,
  getAllVetados,
  getAllGeneralHuespedes,
  getAllGeneralVisitantes,
  getAllGeneralVetados,
  getAllIngresos,
} = require("./queries/ReportQueries.js");
...
app.post("/registerNewPatient", async (req, res) => {
  try {
    ...
    const pacienteR = await registerNewPatient(
      id_u,
      carnet,
      id_area,
      nombre_p,
...
app.post("/registerEntradaUnica", async (req, res) => {
  try {
    ...
    // console.log(apellidos_c)
    const pacienteU = await registerEntradaUnica(
      id_u,
      carnet,
      id_area,
      nombre_p,
...
app.post("/updateinfocliente", async (req, res) => {
  try {
    ...
    // console.log(apellidos_c)
    const pacienteR = await updateInfocliente(
      id_u,
      carnet,
      id_area,
      nombre_p,
...
app.post("/updateinfoEntrada", async (req, res) => {
  try {
    const id_u = req.body.id_u;
    const carnet = req.body.carnet;
    const id_area = req.body.id_area;
    ...
    const id_cliente = req.body.id_cliente;
    // console.log(apellidos_c)
    const pacienteR = await updateInfoentrada(
      id_u,
      carnet,
      id_area,
      nombre_p,
...
app.get("/allgeneralhuespedes", async (req, res) => {
  try {
    const startDate = req.query.startDate; // Obtener fecha de inicio del query string
    const endDate = req.query.endDate; // Obtener fecha de fin del query string
    const allgeneralhuespedes = await getAllGeneralHuespedes(
      startDate,
      endDate
    );
...
app.get("/allgeneralvisitantes", async (req, res) => {
  try {
    const startDate = req.query.startDate; // Obtener fecha de inicio del query string
    const endDate = req.query.endDate; // Obtener fecha de fin del query string
    const allgeneralvisitantes = await getAllGeneralVisitantes(
      startDate,
      endDate
    );
...
app.post("/someclients", async (req, res) => {
  try {
    ...
    const clients = await getClientsByFilter(
      select_Filters,
      select_View,
      debtRange,
      dateRange
